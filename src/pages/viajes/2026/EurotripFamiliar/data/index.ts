...
export { eurotripHero, topNav, hotels, keyFlights, totalBudget, footerNote, utilityNotes };

export const eurotripCities: CityTab[] = [valenciaCity, lisboaCity, parisCity, lourdesCity, romeCity];
