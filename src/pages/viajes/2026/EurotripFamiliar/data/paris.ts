...
export const parisCity: CityTab = {
  ...
  itinerary: [
    d(
      ...
      [
        r(
          "09:25–12:30",
          "Llegada + traslado + dejar maletas",
          "€0",
          "Hotel no tan céntrico, moverse en metro."
        ),
        r(
          "14:00–16:00",
          "Notre-Dame + Île de la Cité",
          "€0",
          "Paseo inicial muy París."
        ),
        r(
          "17:30–21:00",
          "Torre Eiffel + Sena",
          "€23–36",
          "Solo jardines, no hay entradas."
        ),
      ],
    ...
    d(
      ...
      [
        r(
          ...
          "€0",
          "Barrio con más encanto."
        ),
        r(
          "15:00–16:30",
          "Trocadéro + Torre Eiffel de día",
          "€0",
          "Así la ven también con buena luz."
        ),
        r(
          "17:00–19:00",
          "Free tour opcional o Sena",
          "€0–15 propina opcional",
          "Centro histórico o tour de Montmartre."
        ),
      ],
    ...
    d(
      ...
      [
        r(
          "10:30–15:30",
          "Le Marais / paseo final",
          "€0",
          "Último bloque sin prisas."
        ),
  ...
  map: {
    ...
    links: [
      {
        href: "https://www.google.com/maps/dir/?api=1&destination=Eiffel+Tower",
        label: "Abrir ruta a la Torre Eiffel",
      },
      {
        href: "https://www.google.com/maps/dir/?api=1&destination=Palace+of+Versailles",
        label: "Abrir ruta a Versalles",
      },
    ],
  },
}
