    ...
    songs: [
      {
        ...
        assignments: [
          { role: "Voz", musician: "Javier" },
          { role: "Tambora", musician: "Sebastian" },
          { role: "Bajo", musician: "Jose Luis" },
          { role: "Percusión menor", musician: "Kerwith" },
          { role: "Percusión menor", musician: "Talo" },
          { role: "Guitarra", musician: "Cristian" },
        ],
      },
...
export const musicians = [
  ...
  {
    name: "Kerwith Tylor",
    instruments: "Voz, tambora y percusión menor",
    initials: "KT",
  },
  {
    name: "Javier",
