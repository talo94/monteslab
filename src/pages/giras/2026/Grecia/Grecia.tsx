...
export default function GiraGrecia2026() {
  ...
  const selectFrame = (frame: (typeof musicFrames)[number]) => {
    setActiveFrameId(frame.id)
    setActiveSongId(frame.songs[0].id)
  }
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 font-['Source_Serif_4',serif] text-sm font-light italic text-[#7b6d60]">
                    {item.date}
                  </p>
      ...
      >
        <div className="grid gap-6 sm:grid-cols-2">
          {musicFrames.map((frame) => (
            <article key={frame.id} className="rounded-[2rem] bg-[#f3eadc] p-6">
            ...
            {musicians.map((musician) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-[#7b6d60]">
...
function DetailBlock({ title, children, className = "" }: DetailBlockProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={["leading-7", isPendientePorDefinir && "italic"]
          .filter(Boolean)
          .join(" ")}
      >
        {children}
